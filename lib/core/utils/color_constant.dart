...
class ColorConstant {
  ...
  static Color gray8000001 = fromHex('#004b4b4b');
  ...
  static Color blueGray90002 = fromHex('#24272f');

  static Color blueGray90001 = fromHex('#31343b');
  ...
  static Color teal90001 = fromHex('#0c5054');

  static Color blueGray70001 = fromHex('#53565b');
